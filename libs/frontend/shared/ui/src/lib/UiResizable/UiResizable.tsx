...
const UiResizablePanel = ResizablePrimitive.Panel

const UiResizablePanelGroup = ({
  className,
  ...props
...
export { UiResizablePanelGroup, UiResizablePanel, UiResizableHandle }
